...
function DropdownMenuTrigger({ asChild, children, ...props }: MenuPrimitive.Trigger.Props & { asChild?: boolean }) {
  if (asChild && React.isValidElement(children)) {
    return <MenuPrimitive.Trigger data-slot="dropdown-menu-trigger" {...props} render={children as any} />
  }
...
function DropdownMenuItem({
  ...
  if (asChild && React.isValidElement(children)) {
    return <MenuPrimitive.Item {...mergedProps} render={children as any} />
  }

  return (
    <MenuPrimitive.Item {...mergedProps}>
      {children}
    </MenuPrimitive.Item>
  )
}
